...
export default function Projects ()
{
    return (
        <div id="projects">
            <h1 className=' text-5xl font-bold p-14 text-center w-full text-bg capitalize'>Some of my works</h1>
            <div className=' h-[100vh] w-full grid grid-cols-3 grid-rows-2 gap-10 px-40 py-20 relative bg-img2'>
                ...
                <div className=' w-full h-full bg-white relative flex justify-center items-center card s-shadow rounded-xl'>
                    ...
                    <div className=' h-0 w-0 opacity-0 absolute z-10 bg-white  flex flex-col info ' >
                        <h1 className=' text-3xl p-5 text-center bg-black w-full font-bold text-g self-center '>K-Store </h1>
                        <ul className=' text-2xl font-bold mt-10  flex justify-center gap-8'>
                            <li className=' flex items-center '><img className=' h-5 brightness-0' src='/pics/skills/Tailwind_CSS_logo.svg.png'></img></li>
                            <li className=' flex items-center'><FaReact className='mr-2' /> React js</li>
                        </ul>
                        <a href='https://k-commerce.netlify.app/' className='self-center mt-10'>
                ...
                <div className=' w-full h-full bg-white flex justify-center items-center relative card s-shadow rounded-xl'>
                    ...
                    <div className=' h-0 w-0 opacity-0 absolute z-10 bg-white  flex flex-col info ' >
                        ...
                        <h1 className=' text-3xl p-5 text-center bg-black w-full font-bold text-g self-center '>Petadopt </h1>
                        <ul className=' text-2xl font-bold mt-10 flex justify-center items-center gap-8'>
                            <li className=' flex items-center'><img className=' h-5 brightness-0' src='/pics/skills/Tailwind_CSS_logo.svg.png'></img></li>
                            <li className=' flex items-center'><img className=' h-10 brightness-0' src='/pics/skills/next-js-logo-7929BCD36F-seeklogo.com.png'></img></li>
                        </ul>
                        <a href='https://k-petadopt.netlify.app/' className='self-center mt-10'>
                            <button className=' rounded-full btn-15'>
                                View Page
                                <span class="first"></span>
                                <span class="second"></span>
                ...
                <div className=' w-full h-full bg-white relative flex justify-center items-center card s-shadow rounded-xl'>
                    ...
                    <div className=' h-0 w-0 opacity-0 absolute z-10 bg-white  flex flex-col info ' >
                        <h1 className=' text-3xl p-5 text-center bg-black w-full font-bold text-g self-center '>Top-20 </h1>
                        <ul className=' text-2xl font-bold mt-10  flex justify-center gap-8'>
                            <li className=' flex items-center '><img className=' h-5 brightness-0' src='/pics/skills/Tailwind_CSS_logo.svg.png'></img></li>
                            <li className=' flex items-center'><FaReact className='mr-2' /> React js</li>
                        </ul>
                ...
                <div className=' w-full h-full bg-white relative flex justify-center items-center card s-shadow rounded-xl'>
                    ...
                    <div className=' h-0 w-0 opacity-0 absolute z-10 bg-white  flex flex-col info ' >
                        <h1 className=' text-3xl p-5 text-center bg-black w-full font-bold text-g self-center '>Watch List </h1>
                        <ul className=' text-2xl font-bold mt-10  flex justify-center gap-8'>
                            <li className=' flex items-center '><img className=' h-5 brightness-0' src='/pics/skills/Tailwind_CSS_logo.svg.png'></img></li>
                            <li className=' flex items-center'><FaReact className='mr-2' /> React js</li>
                        </ul>
                        <a href='https://kwatchlist.netlify.app/' className='self-center mt-10'>
                            <button className=' rounded-full btn-15'>
                                View Page
                                <span class="first"></span>
                                <span class="second"></span>
                ...
                <div className=' w-full h-full bg-white relative flex justify-center items-center overflow-hidden card s-shadow rounded-xl'>
                    ...
                    <div className=' h-0 w-0 opacity-0 absolute z-10 bg-white  flex flex-col info ' >
                        <h1 className=' text-3xl p-5 text-center bg-black w-full font-bold text-g self-center '>House Lannister </h1>
                        <ul className=' text-2xl font-bold mt-10  flex justify-center gap-8'>
                            <li className=' flex items-center '><FaCss3 className='mr-2' />Css</li>
                            <li className=' flex items-center'><FaReact className='mr-2' /> React js</li>
                        </ul>
                        <a href='https://lannister.netlify.app/#/' className='self-center mt-10'>
                            <button className=' rounded-full btn-15'>
                                View Page
                                <span class="first"></span>
                                <span class="second"></span>
                ...
                <div className=' w-full h-full bg-white relative flex justify-center items-center card s-shadow rounded-xl'>
                    ...
                    <div className=' h-0 w-0 opacity-0 absolute z-10 bg-white  flex flex-col info ' >
                        <h1 className=' text-3xl p-5 text-center bg-black w-full font-bold text-g self-center '>Anti-Christos</h1>
                        <ul className=' text-2xl font-bold mt-10  flex justify-center gap-8'>
                        ...
                        <a href='https://mpeetl3vwnqdw0tp5nz38q.on.drv.tw/%D8%A7%D9%86%D8%AA%D9%8A%D8%AE%D8%B1%D9%8A%D8%B3%D8%AA%D9%88%D8%B3%20/index%20.html' className='self-center mt-10'>
                            <button className=' rounded-full btn-15'>
                                View Page
                                <span class="first"></span>
                                <span class="second"></span>
